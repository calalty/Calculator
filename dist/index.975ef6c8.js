...
class Calculator {
    constructor(prevOperandTextEl1, currOperandTextEl1){
        this.prevOperandTextEl = prevOperandTextEl1;
        this.currOperandTextEl = currOperandTextEl1;
        this.clear();
    }
    updateDisplay() {
        this.currOperandTextEl.textContent = this.getDisplayNumber(this.currOperand);
        if (this.operation != null) this.prevOperandTextEl.textContent = `${this.prevOperand} ${this.operation}`;
    ...
    getDisplayNumber(number) {
        ...
        else integerDisplay = integerDigits.toLocaleString("eng", {
...
},{}]},["ShInH","8lqZg"], "8lqZg", "parcelRequireff1f")
